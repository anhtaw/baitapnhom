                    ...
                    <div class="col-lg-3">
                        <div class="header-phone ">
                            ...
                            <div class="text">
                                ...
                                <p class="font-weight-bold number m"  >+01-202-555-0181</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="container">
                    <div class="home-content text-center text-sm-left position-relative">
                        <div class="hero-partial-image image-right">
                            <img src="{{URL::asset('/image/bg-images/home-slider-2-ai.png')}}" alt="">
                        </div>
                ...
                <div class="container">
                    <div class="home-content text-center text-sm-left position-relative">
                        <div class="hero-partial-image image-left">
                            <img src="{{URL::asset('/image/bg-images/home-slider-1-ai.png')}}" alt="">
                        </div>
            ...
            <div class="row space-db--30">
                <div class="col-lg-6 col-md-6 mb--30">
                    <a href="" class="promo-image promo-overlay">
                        <img src="{{URL::asset('/image/bg-images/promo-banner-with-text.jpg')}}" alt="">
                    </a>
                </div>
                <div class="col-lg-6 col-md-6 mb--30">
                    <a href="" class="promo-image promo-overlay">
                        <img src="{{URL::asset('/image/bg-images/promo-banner-with-text-2.jpg')}}" alt="">
                    </a>
                </div>
            </div>
        </div>
